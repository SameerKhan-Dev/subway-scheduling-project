...
public class Station {
    ...
    public Station(String name, HashMap<String, ArrayList<LocalTime>> schedule, String subwayLine, ArrayList<String> directions, Boolean goTransit, Boolean viaRail, Boolean isInterchange){
        this.name = name;
